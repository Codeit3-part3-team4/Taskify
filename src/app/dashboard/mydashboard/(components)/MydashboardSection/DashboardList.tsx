...
export default function DashboardList() {
  ...
  return (
    <div className="md:flex md:flex-col md:items-center">
      <div className="flex flex-col gap-y-2 md:justify-center md:flex-row md:flex-wrap md:gap-4  ">
        <div className="flex items-center border border-gray_D9D9D9 rounded-lg h-14 md:w-72 md:h-20 bg-white hover:bg-gray-D9D9D9">
        ...
        {displayedDashboards &&
          displayedDashboards.map(dashboard => (
            <Link key={dashboard.id} href={`/dashboard/${dashboard.id}`}>
              <div className="flex items-center border border-gray_D9D9D9 rounded-lg h-14 md:w-72 md:h-20 bg-white hover:bg-gray-D9D9D9 duration-300 hover:-translate-y-2">
